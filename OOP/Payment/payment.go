...
/*Define interface that will be implemented by creditCard object and Cash object*/
...
func CreateCreditAccount(ownerName, cardNumber string, expirationMonth,
	expirationYear, securityCode int) *CreditCard {
	return &CreditCard{
		ownerName:       ownerName,
